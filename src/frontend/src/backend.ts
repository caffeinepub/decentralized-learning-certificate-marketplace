...
import type { BadgeId as _BadgeId, SkillBadge as _SkillBadge, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllBadges(): Promise<Array<SkillBadge>> {
        if (this.processError) {
            try {
    ...
    async getBadgesForUser(arg0: Principal): Promise<Array<SkillBadge>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBadgesForUser(arg0);
                return from_candid_vec_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async issueBadge(arg0: Principal, arg1: string, arg2: string | null, arg3: string | null): Promise<BadgeId> {
        if (this.processError) {
            try {
                const result = await this.actor.issueBadge(arg0, arg1, to_candid_opt_n12(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n12(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async verifyBadge(arg0: BadgeId): Promise<SkillBadge | null> {
        if (this.processError) {
            try {
                const result = await this.actor.verifyBadge(arg0);
...
function from_candid_SkillBadge_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SkillBadge): SkillBadge {
...
function from_candid_opt_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_SkillBadge]): SkillBadge | null {
    return value.length === 0 ? null : from_candid_SkillBadge_n4(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        level: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.level)),
        issuer: value.issuer,
        issueTimestamp: value.issueTimestamp
    };
}
...
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_SkillBadge>): Array<SkillBadge> {
    return value.map((x)=>from_candid_SkillBadge_n4(_uploadFile, _downloadFile, x));
}
